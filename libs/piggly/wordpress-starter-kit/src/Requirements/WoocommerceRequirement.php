...
namespace AppMax\WooCommerce\Gateway\Vendor\Piggly\Wordpress\Requirements;

use Exception;
use AppMax\WooCommerce\Gateway\Vendor\Piggly\Wordpress\Requirements\Interfaces\RequirementInterface;
/**
