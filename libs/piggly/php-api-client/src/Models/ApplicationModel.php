...
abstract class ApplicationModel extends AbstractModel implements ApplicationInterface
{
     ...
     * @return EnvInterface
     */
    public abstract function createEnvironment() : EnvInterface;
    /**
    ...
    {
        return ['environment' => $this->get('environment', static::ENV_HOMOL), 'debug_mode' => $this->get('debug_mode', \false), 'client_id' => $this->get('client_id'), 'client_secret' => $this->get('client_secret'), 'credential' => $this->has('credential') ? $this->get('credential')->export() : [], 'certificate' => $this->get('certificate', [])];
    }
    /**
