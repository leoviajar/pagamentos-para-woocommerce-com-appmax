...
class Configuration
{
    ...
    {
        $this->_settings = ['api.keys' => [], 'http.headers' => new HeaderBag(), 'custom' => [], 'curl' => []];
    }
    /**
    ...
    {
        $this->_settings['http.host'] = \trim($host, '/');
        return $this;
    }
    /**
     * Get the HTTP host.
    ...
    {
        return isset($this->_settings['logger']) && !empty($this->_settings['logger']) ? \true : \false;
    }
    /**
    ...
    public function log($level, $message, array $context = [])
    {
        ...
        $this->_settings['logger']->addRecord($level, \sprintf('%s :: %s', $this->getEnv(), (string) $message), $context);
        return $this;
    }
    /**
