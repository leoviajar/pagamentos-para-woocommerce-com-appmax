...
namespace AppMax\WooCommerce\Gateway\Vendor\Piggly\ApiClient\Exceptions;
...
class ApiResponseException extends Exception
{
    ...
    public function __construct($message = "", $code = 0, $response = null)
    {
        ...
        $response->getRequest()->getConfig()->log(Logger::ERROR, 'api.request.error -> ' . $message, ['method' => $response->getMethod(), 'uri' => $response->getUri()]);
    }
    /**
     * Get the response.
     *
