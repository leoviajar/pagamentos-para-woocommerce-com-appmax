...
namespace AppMax\WooCommerce\Gateway\Vendor\Piggly\ApiClient\Payloads;

use Exception;
use InvalidArgumentException;
use AppMax\WooCommerce\Gateway\Vendor\Piggly\ApiClient\Interfaces\FixableInterface;
...
abstract class AbstractPayload
{
    ...
    {
        if (!\in_array($needle, \array_keys(static::schema()), \true)) {
     ...
     */
    protected static abstract function schema() : array;
}
