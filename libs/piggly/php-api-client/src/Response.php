...
class Response
{
     ...
     * @return void
     */
    public function __construct($status, $uri, $method, $headers = null, $body = null, $raw = null, $request = null)
    {
        $this->_status = $status;
    ...
    {
        return [self::BODY_AS_ARRAY, self::BODY_AS_STRING, self::BODY_AS_OBJECT, self::BODY_AS_SPLFILEOBJECT];
    }
}
