...
use AppMax\WooCommerce\Gateway\Vendor\Monolog\Formatter\LineFormatter;
...
use AppMax\WooCommerce\Gateway\Vendor\Monolog\Utils;
use AppMax\WooCommerce\Gateway\Vendor\PhpConsole\Connector;
use AppMax\WooCommerce\Gateway\Vendor\PhpConsole\Handler as VendorPhpConsoleHandler;
use AppMax\WooCommerce\Gateway\Vendor\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private $options = [
        ...
        'classesPartialsTraceIgnore' => ['AppMax\\WooCommerce\\Gateway\\Vendor\\Monolog\\'],
    ...
    {
        if (!\class_exists('AppMax\\WooCommerce\\Gateway\\Vendor\\PhpConsole\\Connector')) {
