 ...
 */
namespace AppMax\WooCommerce\Gateway\Vendor\Monolog\Handler\FingersCrossed;
...
class ChannelLevelActivationStrategy implements ActivationStrategyInterface
{
    ...
    public function __construct($defaultActionLevel, array $channelToActionLevel = [])
    {
        ...
        $this->channelToActionLevel = \array_map('AppMax\\WooCommerce\\Gateway\\Vendor\\Monolog\\Logger::toMonologLevel', $channelToActionLevel);
    }
    /**
