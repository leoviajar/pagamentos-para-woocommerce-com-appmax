...
use AppMax\WooCommerce\Gateway\Vendor\FPDF;
...
class QRFpdf extends QROutputAbstract
{
    public function __construct(SettingsContainerInterface $options, QRMatrix $matrix)
    {
        if (!class_exists(FPDF::class)) {
            ...
            throw new QRCodeException('The QRFpdf output requires FPDF as dependency but the class "\\FPDF" couldn\'t be found.');
